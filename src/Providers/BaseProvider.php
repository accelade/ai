...
abstract class BaseProvider implements AIProvider
{
    ...
    /**
     * Load configuration from accelade-ai config file.
     */
    protected function loadFromConfig(): void
    {
        $providerName = $this->getName();
        $config = config("accelade-ai.providers.{$providerName}", []);
    ...
    /**
     * Default implementation for chat with tools (override in providers that support it).
     */
